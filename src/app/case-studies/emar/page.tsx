  ...
  return (
    <div className="group relative overflow-hidden bg-black">
      ...
      <button
        ...
        className="absolute left-3 top-1/2 z-30 flex h-9 w-9 -translate-y-1/2 items-center justify-center border border-white/20 bg-black/70 text-sm text-white opacity-0 backdrop-blur-md transition group-hover:opacity-100"
      >
        ←
      </button>
      ...
      <button
        ...
        className="absolute right-3 top-1/2 z-30 flex h-9 w-9 -translate-y-1/2 items-center justify-center border border-white/20 bg-black/70 text-sm text-white opacity-0 backdrop-blur-md transition group-hover:opacity-100"
      >
        →
      </button>

      <span className="absolute right-3 top-3 z-30 border border-white/15 bg-black/70 px-3 py-2 text-[10px] text-white/70 opacity-0 backdrop-blur-md transition group-hover:opacity-100">
...
function WebsiteCarousel({ item }: { item: MediaItem }) {
  ...
  return (
    <div className="group relative flex min-h-[520px] w-full items-center justify-center bg-[#050907] md:min-h-[640px]">
      <img
        src={item.slides[currentSlide]}
      ...
      <button
        ...
        className="absolute left-4 top-1/2 z-30 flex h-11 w-11 -translate-y-1/2 items-center justify-center border border-white/20 bg-black/70 text-white backdrop-blur-md transition hover:bg-black"
      >
        ←
      </button>
      ...
      <button
        ...
        className="absolute right-4 top-1/2 z-30 flex h-11 w-11 -translate-y-1/2 items-center justify-center border border-white/20 bg-black/70 text-white backdrop-blur-md transition hover:bg-black"
      >
        →
      </button>

      <span className="absolute right-4 top-4 z-30 border border-white/15 bg-black/70 px-3 py-2 text-[10px] text-white/70 backdrop-blur-md">
        {currentSlide + 1} / {item.slides.length}
      </span>
    </div>
  );
